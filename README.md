...
- Approfondimenti interni alle card usando gli elementi HTML `<details>` e `<summary>`.
...
## Avvio del progetto
Per visualizzare la pagina è sufficiente aprire il file `index.html` nel browser 
